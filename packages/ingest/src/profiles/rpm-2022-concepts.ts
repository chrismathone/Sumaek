...
/**
 * **정본 개념은 여기서 새로 짓지 않는다.** 슬러그·이름·설명은
 * `packages/db/scripts/data/middle-math-concept-catalog.mts`에 있는
 * 2022 개정 성취기준 매핑을 그대로 옮긴 것이다.
 *
 * 처음에는 교재의 소단원 결을 따라 개념을 잘게(절댓값·대소·덧셈뺄셈·
 * 곱셈나눗셈…) 새로 지었다가 되돌렸다. 그러면 DB에 이미 있는 정본 개념과
 * **겹치는 별개 개념**이 생겨 문항이 두 갈래로 흩어진다 — 숙련도도,
 * 출제 풀도, 개념 화면도 반씩 나뉜다. 개념을 더 잘게 나눌 필요가 있다면
 * 그건 카탈로그를 고칠 일이지 반입 프로파일이 할 일이 아니다(ADR-0011).
 */
...
export const RPM_M1_CH2_TITLE_TO_CONCEPT: ReadonlyMap<string, ConceptWeight[]> =
  conceptTable([
    ...
    ["절댓값", [{ slug: "m1-rational-order", weight: 1 }]],
    ["수의 대소 관계", [{ slug: "m1-rational-order", weight: 1 }]],
    ["부등호의 사용", [{ slug: "m1-rational-order", weight: 1 }]],
    ...
    ["절댓값의 성질", [{ slug: "m1-rational-order", weight: 1 }]],
    ["절댓값을 이용하여 수 찾기", [{ slug: "m1-rational-order", weight: 1 }]],
    ["절댓값이 같고 부호가 반대인 두 수", [{ slug: "m1-rational-order", weight: 1 }]],
    ["절댓값의 응용", [{ slug: "m1-rational-order", weight: 1 }]],
    ["부등호를 사용하여 나타내기", [{ slug: "m1-rational-order", weight: 1 }]],
    ["두 유리수 사이에 있는 정수", [{ slug: "m1-rational-order", weight: 1 }]],
    /* 「조건을 만족시키는 수의 대소 관계」는 절댓값 조건으로 범위를 좁힌 뒤
     * 크기를 비교한다 — 한쪽으로 몰면 숙련도 증거가 한쪽에만 쌓인다. */
    [
      "조건을 만족시키는 수의 대소 관계",
      [{ slug: "m1-rational-order", weight: 1 }],
    ],

    // ── 04 정수와 유리수의 계산 · 소단원
    ["유리수의 덧셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["유리수의 덧셈 유리수의 뺄셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["덧셈과 뺄셈의 혼합 계산", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["유리수의 곱셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["유리수의 곱셈 유리수의 나눗셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["덧셈 뺄셈 곱셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],

    // ── 04 정수와 유리수의 계산 · 유형
    ["덧셈의 계산 법칙", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["유리수의 뺄셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["부호가 생략된 수의 덧셈과 뺄셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    [
      "어떤 수보다 만큼 큰 수 또는 작은 수",
      [{ slug: "m1-rational-arithmetic", weight: 1 }],
    ],
    ["덧셈과 뺄셈 사이의 관계", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    [
      "바르게 계산한 답 구하기 덧셈 뺄셈",
      [{ slug: "m1-rational-arithmetic", weight: 1 }],
    ],
    [
      ...
      [
        { slug: "m1-rational-arithmetic", weight: 0.5 },
        { slug: "m1-rational-order", weight: 0.5 },
      ],
    ],
    ["덧셈과 뺄셈의 활용 ⑴", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["덧셈과 뺄셈의 활용 ⑵", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["곱셈의 계산 법칙", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    [
      "네 유리수 중에서 세 수를 뽑아 곱하기",
      [{ slug: "m1-rational-arithmetic", weight: 1 }],
    ],
    ["거듭제곱의 계산", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    /* 지면은 「(-1)ⁿ의 계산」인데 수식이 제목에서 빠져 「의 계산」만 남는다.
     * 추출기가 내놓는 문자열이 이것이므로 이대로 둔다. */
    ["의 계산", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["분배법칙", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["역수", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["유리수의 나눗셈", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["곱셈과 나눗셈의 혼합 계산", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    ["곱셈과 나눗셈 사이의 관계", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    [
      "바르게 계산한 답 구하기 곱셈 나눗셈",
      [{ slug: "m1-rational-arithmetic", weight: 1 }],
    ],
    ["유리수의 부호 결정", [{ slug: "m1-rational-arithmetic", weight: 1 }]],
    [
      "문자로 주어진 수의 대소 관계",
      [
        { slug: "m1-rational-order", weight: 0.5 },
...
export const RPM_M1_CH2_UNIT_TO_CONCEPT: ReadonlyMap<string, ConceptWeight[]> =
  conceptTable([
    [
      "정수와 유리수",
      [
        { slug: "m1-integers-rationals", weight: 0.5 },
        { slug: "m1-rational-order", weight: 0.5 },
      ],
    ],
    [
      /* 이 중단원은 정본 개념이 하나다 — 나눌 것이 없다 */
      "정수와 유리수의 계산",
      [{ slug: "m1-rational-arithmetic", weight: 1 }],
    ],
  ]);
...
export const RPM_M1_CH3_TITLE_TO_CONCEPT: ReadonlyMap<string, ConceptWeight[]> =
  conceptTable([
    ...
    ["문자를 사용한 식", [{ slug: "m1-algebraic-expressions", weight: 1 }]],
    [
      "곱셈 기호와 나눗셈 기호의 생략",
      [{ slug: "m1-algebraic-expressions", weight: 1 }],
    ],
    ["식의 값", [{ slug: "m1-algebraic-expressions", weight: 1 }]],
    ["다항식과 일차식", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["일차식과 수의 곱셈", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["나눗셈", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["나눗셈 일차식의 덧셈", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["뺄셈", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ...
    ["식의 값 구하기", [{ slug: "m1-algebraic-expressions", weight: 1 }]],
    [
    ...
    ["다항식", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["일차식", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    [
      "일차식과 수의 곱셈 나눗셈",
      [{ slug: "m1-linear-expression-ops", weight: 1 }],
    ],
    ["동류항", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["일차식의 덧셈과 뺄셈", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    [
    ...
    ["문자에 일차식을 대입하기", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["어떤 식 구하기", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    ["바르게 계산한 식 구하기", [{ slug: "m1-linear-expression-ops", weight: 1 }]],
    [
    ...
    // ── 06 일차방정식의 풀이 · 소단원
    ["방정식과 항등식", [{ slug: "m1-equation-basics", weight: 1 }]],
    ["등식의 성질", [{ slug: "m1-equation-basics", weight: 1 }]],
    ["일차방정식의 풀이", [{ slug: "m1-linear-equation", weight: 1 }]],

    // ── 06 · 유형
    ["등식", [{ slug: "m1-equation-basics", weight: 1 }]],
    ["문장을 등식으로 나타내기", [{ slug: "m1-equation-basics", weight: 1 }]],
    ["방정식의 해", [{ slug: "m1-equation-basics", weight: 1 }]],
    ["항등식", [{ slug: "m1-equation-basics", weight: 1 }]],
    ["항등식이 되는 조건", [{ slug: "m1-equation-basics", weight: 1 }]],
    [
      "등식의 성질을 이용한 방정식의 풀이",
      [{ slug: "m1-equation-basics", weight: 1 }],
    ],
    ["이항", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["일차방정식", [{ slug: "m1-linear-equation", weight: 1 }]],
    [
      "계수가 소수인 일차방정식의 풀이",
      [{ slug: "m1-linear-equation", weight: 1 }],
    ],
    [
      "계수가 분수인 일차방정식의 풀이",
      [{ slug: "m1-linear-equation", weight: 1 }],
    ...
    ["특수한 해를 갖는 경우", [{ slug: "m1-linear-equation", weight: 1 }]],

    // ── 07 일차방정식의 활용 · 소단원·유형 (전부 같은 개념이다)
    ["일차방정식의 활용 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["농도에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["어떤 수에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    [
      "연속하는 자연수에 대한 문제",
      [{ slug: "m1-linear-equation", weight: 1 }],
    ],
    ["자릿수에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["나이에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["예금에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["개수의 합이 일정한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["도형에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["과부족에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["증가 감소에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["전체의 양에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    [
    ...
    ["원가 정가에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["일에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["긴 의자에 대한 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
    ["규칙을 찾는 문제", [{ slug: "m1-linear-equation", weight: 1 }]],
  ]);
...
export const RPM_M1_CH3_UNIT_TO_CONCEPT: ReadonlyMap<string, ConceptWeight[]> =
  conceptTable([
    [
      "문자의 사용과 식의 계산",
      [
        { slug: "m1-algebraic-expressions", weight: 0.5 },
        { slug: "m1-linear-expression-ops", weight: 0.5 },
      ],
    ],
    [
      "일차방정식의 풀이",
      [
        { slug: "m1-equation-basics", weight: 0.5 },
        { slug: "m1-linear-equation", weight: 0.5 },
      ],
    ],
    /* 활용 중단원은 개념이 하나다 — 나눌 것이 없다 */
    ["일차방정식의 활용", [{ slug: "m1-linear-equation", weight: 1 }]],
  ]);
...
export const RPM_M1_CH4_TITLE_TO_CONCEPT: ReadonlyMap<string, ConceptWeight[]> =
  conceptTable([
    // ── 08 좌표와 그래프
    ["좌표와 좌표평면", [{ slug: "m1-coordinates", weight: 1 }]],
    ["사분면", [{ slug: "m1-coordinates", weight: 1 }]],
    ["그래프와 그 해석", [{ slug: "m1-graphs", weight: 1 }]],
    [
      "순서쌍과 좌표평면 위의 점의 좌표",
      [{ slug: "m1-coordinates", weight: 1 }],
    ],
    /* 지면은 「x축 또는 y축 위의 점의 좌표」 — 축 이름이 수식이라 빠진다 */
    ["축 또는 축 위의 점의 좌표", [{ slug: "m1-coordinates", weight: 1 }]],
    ["좌표평면 위의 도형의 넓이", [{ slug: "m1-coordinates", weight: 1 }]],
    ["대칭인 점의 좌표", [{ slug: "m1-coordinates", weight: 1 }]],
    [
    ...
    ["상황을 그래프로 나타내기", [{ slug: "m1-graphs", weight: 1 }]],
    ["그래프의 해석", [{ slug: "m1-graphs", weight: 1 }]],
    ["주기적 변화를 나타내는 그래프", [{ slug: "m1-graphs", weight: 1 }]],
    ["그래프의 해석 두 그래프의 비교", [{ slug: "m1-graphs", weight: 1 }]],

    // ── 09 정비례와 반비례 · 정비례
    ["정비례", [{ slug: "m1-proportionality", weight: 1 }]],
    ["정비례 관계", [{ slug: "m1-proportionality", weight: 1 }]],
    ["정비례 관계의 식 구하기", [{ slug: "m1-proportionality", weight: 1 }]],
    [
      "정비례 관계 의 활용 와 사이의 관계를 나타내는 식 구하기",
      [{ slug: "m1-proportionality", weight: 1 }],
    ],
    ["정비례 관계 의 활용", [{ slug: "m1-proportionality", weight: 1 }]],
    ["정비례 관계 의 그래프", [{ slug: "m1-proportionality", weight: 1 }]],
    [
    ...
    ["정비례 관계 의 그래프의 성질", [{ slug: "m1-proportionality", weight: 1 }]],
    [
      "정비례 관계의 그래프가 주어진 경우",
      [{ slug: "m1-proportionality", weight: 1 }],
    ],
    ...
    ["두 정비례 관계의 그래프 비교하기", [{ slug: "m1-proportionality", weight: 1 }]],

    // ── 09 정비례와 반비례 · 반비례
    ["반비례", [{ slug: "m1-proportionality", weight: 1 }]],
    ["반비례 관계", [{ slug: "m1-proportionality", weight: 1 }]],
    ["반비례 관계의 식 구하기", [{ slug: "m1-proportionality", weight: 1 }]],
    ["반비례 관계 의 활용", [{ slug: "m1-proportionality", weight: 1 }]],
    ["반비례 관계 의 그래프", [{ slug: "m1-proportionality", weight: 1 }]],
    [
      "반비례 관계의 그래프가 주어진 경우",
      [{ slug: "m1-proportionality", weight: 1 }],
    ],
    ...
    ["의 절댓값 사이의 관계", [{ slug: "m1-proportionality", weight: 1 }]],
    ["지나는 점", [{ slug: "m1-proportionality", weight: 1 }]],
    ["성질", [{ slug: "m1-proportionality", weight: 1 }]],
    ["도형의 넓이", [{ slug: "m1-proportionality", weight: 1 }]],
...
export const RPM_M1_CH4_UNIT_TO_CONCEPT: ReadonlyMap<string, ConceptWeight[]> =
  conceptTable([
    [
      "좌표와 그래프",
      [
        { slug: "m1-coordinates", weight: 0.5 },
        { slug: "m1-graphs", weight: 0.5 },
      ],
    ],
    [
      /* 정비례와 반비례는 정본 개념 하나다 */
