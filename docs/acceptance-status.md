...
| 48 | 성취기준→문항 추적 사슬 | 🟡 | 사슬 앞 두 고리가 실데이터로 잇겼다 — 성취기준 60개(원문·체크섬) + RPM 1단원 개념 5개의 사람 큐레이션 매핑, 실측: [9수01-01] 개념 3·문항 104, [9수01-02] 개념 2·문항 109 (`curriculum-chain.test.ts`가 상시 단언). **학습 목표·평가 증거·블루프린트 도메인은 여전히 없고**, 매핑도 1단원 5개념뿐 (나머지 55개 성취기준은 연결 개념 0) |
